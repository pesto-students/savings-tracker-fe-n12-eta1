        ...
        <>
            <div className="col-md-3 mb-4 mb-lg-0 d-flex d-sm-block" id="sidebar">
                <div className={active === 'dashboard' ? 'dash_bord active' : 'dash_bord'}>
                    <Link to="/dashboard">
                        <p><i className="fa fa-pie-chart mr-md-2"></i> <span className="d-none d-sm-inline">Dashboard</span></p>
                    </Link>
                </div>

                <div className={active === 'goals' ? 'dash_bord active' : 'dash_bord'}>
                    <Link to="/goals">
                        <p><i className="fa fa-bullseye mr-md-2"></i> <span className="d-none d-sm-inline">My Goals</span></p>
                    </Link>
                </div>
                ...
                <div className={active === 'subscription' ? 'dash_bord active' : 'dash_bord'}>
                    <Link to="/subscription">
                        <p><i className="fas fa-credit-card mr-md-2"></i> <span className="d-none d-sm-inline">Subscription</span> </p>
                    </Link>
                </div>
